    ...
    return (
      <div className="row align-items-center">
        ...
        <div className="col-12 col-lg-5 col-xl-6 order-lg-2 mb-8 mb-lg-0">
          {/* Image */}
          <img
            src={require(`/images/hero/04.png`)}
            className="img-fluid"
            alt="..."
          />
        </div>
        <div className="col-12 col-lg-7 col-xl-6 order-lg-1">
          ...
          <h6 className="border rounded-pill px-3 py-2 text-muted d-inline-block">
            {" "}
            <span className="badge badge-pill badge-primary mr-3">New</span> Say
            Hello to all Bootsland
          </h6>
          <h1 className="display-4 mt-3">
            Bootsland Creative{" "}
            <span className="text-primary font-w-5">App Landing</span> Page
          </h1>
          {/* Text */}
