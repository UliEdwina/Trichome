              ...
              <div className="row justify-content-center mb-11">
                <div className="col-12 col-lg-8">
                  <form className="form-inline my-2 my-lg-0">
                    ...
                    />
                    <button
                      className="btn btn-primary my-2 my-sm-0 col-auto"
                      type="submit"
                    >
                      Search Blog
                    </button>
                      ...
                      <nav aria-label="...">
                        <ul className="pagination">
                          ...
                          <li className="page-item">
                            <Link
                              className="page-link border-0 rounded text-dark"
                              to="/"
                            >
                              1
                            </Link>
                  ...
                  <div>
                    ...
                    <article>
                      <div className="media align-items-center">
                        <div className="media-body">
                          ...
                          <Link
                            className="d-inline-block text-muted small font-w-5"
                            to="/"
                          >
                            27 November 2019
                          </Link>
                        ...
                        <img
                          src={require(`/images/blog/blog-thumb/01.png`)}
                          className="ml-3"
                          alt="..."
                        />
                      </div>
                    ...
                    <article className="mt-5">
                      <div className="media align-items-center">
                        ...
                        <img
                          src={require(`/images/blog/blog-thumb/02.png`)}
                          className="ml-3"
                          alt="..."
                        />
                      </div>
                    ...
                    <article className="mt-5">
                      <div className="media align-items-center">
                        ...
                        <img
                          src={require(`/images/blog/blog-thumb/03.png`)}
                          className="ml-3"
                          alt="..."
                        />
                      </div>
                  ...
                  <div className="mt-11">
                    ...
                    <ul className="list-unstyled list-group list-group-flush mb-5">
                      <li className="mb-4">
                        ...
                        >
                          All
                          <span className="badge badge-primary-soft text-dark font-weight-normal p-2 badge-pill ml-2">
                            74
                          </span>
                        </Link>
                      </li>
